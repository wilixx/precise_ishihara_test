...
"""
  author£º Allen
  This file to dalonize 10 images with a specific type e.g."p" in a folder.
"""
...
'''
    parser = argparse.ArgumentParser()
    args = parser.parse_args()
#     Here I am going to put the image in
    for go in range(10):
...
#         image = Image.open('number_img/number_'+this_num+'.png')
        ...
        orig_img = Image.open('number_plate/number_'+this_num+'.png')
        args.type = "d"
        args.simulate=True
        args.daltonize=False
#         args.output_image="this_is_sim_6_t.png"
        args.output_image='number_sim/number_'+this_num+'.png'
